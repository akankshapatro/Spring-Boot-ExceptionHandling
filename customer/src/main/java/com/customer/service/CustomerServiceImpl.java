//Step 4: Service class Implementation which defines the main logic
...
public class CustomerServiceImpl implements CustomerService{
	...
	//Method to add new customer details to database.Throws CustomerAlreadyExistsException when customer detail already exist
	...
	//Method to update customer details to database.Throws NoSuchCustomerExistsException when customer doesn't already exist in database
